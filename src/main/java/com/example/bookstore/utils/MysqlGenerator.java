...
public class MysqlGenerator {
     ...
     * 包所在路径
     */
    private static final String packagePath = "com.example.bookstore";
    /**
     * 实体所在的module
     */
     ...
     * 密码
     */
    private static final String password = "wzs@zlx1314";

    /**
     * 作者
     */
    private static final String authorname = "wzs";
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/" + database + "?useUnicode=true&characterEncoding=UTF-8&serverTimezone=UTC");
