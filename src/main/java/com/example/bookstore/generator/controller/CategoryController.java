...
public class CategoryController {
    ...
    @ApiOperation(value = "修改Category信息")
    ...
    public Result updateUsefulByIds(String ids, Integer useful) {
        Result result = new Result();
        categoryService.updateUsefulByIds(ids, useful);
        result.success("更新成功");
        return result;
    }
    ...
    public Result page(Integer pageNum, Integer pageSize,String name) {
        Result result = new Result();
        result.success("获取list成功");
        result.setData(categoryService.page(pageNum, pageSize, name));
        return result;
    }

    @RequestMapping(method = RequestMethod.POST, value = "/category")
    public Result category(String id) {
        Result result = new Result();
        result.success("获取category成功");

        result.setData(categoryService.getnems(id));
