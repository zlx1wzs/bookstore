...
*/
    @CrossOrigin
    @RestController
@RequestMapping("/generator/payment")
    public class PaymentController {
    @Autowired
    private PaymentService paymentService;

        @ApiOperation(value = "保存Payment信息")
    ...
    return result;
        ...
        @ApiOperation(value = "修改Payment信息")
    ...
    Result result = new Result();
    paymentService.updateUsefulByIds(ids,useful);
    result.success("更新成功");
    return result;
    }
    ...
    result.setData(paymentService.list());
    return result;
    }
    ...
    Result result = new Result();
    result.success("获取list成功");
    result.setData(paymentService.page(pageNum,pageSize));
    return result;
    }
    }
