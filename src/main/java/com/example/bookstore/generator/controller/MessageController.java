...
@RequestMapping("/generator/message")
    ...
    private MessageService messageService;
        ...
        @ApiOperation(value = "保存Message信息")
    ...
    return result;
        ...
        @ApiOperation(value = "修改Message信息")
    ...
    Result result = new Result();
    messageService.updateUsefulByIds(ids,useful);
    result.success("更新成功");
    return result;
    }
    ...
    result.setData(messageService.list());
    return result;
    }
    ...
    Result result = new Result();
    result.success("获取list成功");
    result.setData(messageService.page(pageNum,pageSize));
    return result;
    }
    }
